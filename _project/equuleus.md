...
EQUULEUS adopts a water registrojet propulsion system for trajectory control for trajectory design control and angular momentum unloading. Large amount of heat required for vaporization and severe power constraint makes the thermal design process tightly coupled with other subsystems. 
Through thermal vacuum tests and propulsion system operation tests, we analuzyed the feasibility of the entire mission phase.
...
![image](/images/thermal-vacuum-test.png)
